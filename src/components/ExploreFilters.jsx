        ...
        <div className="space-y-3">
            ...
            <div className="flex gap-2">
                ...
                <button
                    ...
                    className={`px-4 py-4 rounded-2xl flex items-center gap-2 transition-all ${filtersExpanded
                        ...
                        <div className="space-y-4 pt-2">
                            ...
                            <div className="flex gap-3 flex-wrap">
                                ...
                                <button
                                    ...
                                    className={`px-5 py-3 rounded-2xl text-xs font-black uppercase tracking-wider transition-all flex items-center gap-2 ${thisWeekActive
                                        ? 'bg-primary text-white shadow-lg'
                                        : 'bg-secondary/10 border border-secondary/20 text-secondary hover:text-primary hover:border-primary/50'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`px-5 py-3 rounded-2xl text-xs font-black uppercase tracking-wider transition-all flex items-center gap-2 ${dateRange.start && !thisWeekActive
                                ...
                                {(dateRange.start || thisWeekActive) && (
                                    <button
                                        onClick={clearDates}
                                        className="px-4 py-3 rounded-2xl text-xs font-bold text-secondary/60 hover:text-primary transition-all"
                                    >
                                        Clear Dates
                                    </button>
                                )}
                            ...
                            <div className="flex gap-2 overflow-x-auto no-scrollbar pb-2">
                                {CATEGORIES.map(cat => {
                                    ...
                                    <button
                                        ...
                                        className={`px-5 py-2.5 rounded-full text-xs font-black uppercase tracking-wider whitespace-nowrap transition-all border flex items-center gap-2 ${activeCategory === cat.id
                            ...
                            <div className="flex gap-2">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 py-3 rounded-xl text-[11px] font-black uppercase tracking-wider transition-all flex items-center justify-center gap-2 ${sizeFilter === size.id
                            ...
                            {hasActiveFilters && (
                                <motion.button
                                    ...
                                    className="w-full py-3 rounded-xl text-xs font-bold uppercase tracking-wider bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 transition-all flex items-center justify-center gap-2"
                                >
                                    <X size={14} />
                                    Reset All Filters
                                </motion.button>
